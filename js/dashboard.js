...
function updateText(state){
    ...
    'The first graph shows Vaccine x Death Putrajaya scatter plot. Most of the plot is scattered at the beginning of the plot. When 77,977 people already vaccinated, 44 death occured. Next, Vaccine distribution in Perlis. Pfizer is the highest distribution which have 404,291 doses. Followed by Sinovac, AstraZeneca, CanSino and Sinopharm accordingly. Next, death line chart for Perlis. the chart reach its peak on September 2021 with total death of 44 and followed by 43 on October 2021. It keep decreasing until it reach January 2022. Howeverr it rises back until March 2022 with total death of 32 and it keep decreasing after that. Lastly, vaccine line chart for Perlis. The chart reach its peak on August 2021 with 91,608 total of vaccine distributed. The chart keep decreasing after it reach its own peak.']
